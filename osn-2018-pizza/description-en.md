...
In each of your turns, your program must output a line containing an integer C denoting that you will take a slice of pizza of flavor C. If there is no more pizza of flavor that you love, then C must be 0.
